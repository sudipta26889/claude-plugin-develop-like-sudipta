---
description: Create a development plan for a new feature or task. Brainstorm → plan → verify.
---
...
- Task breakdown for subagent dispatch

Follow Pillar 1 (Plan First) from the develop-like-sudipta skill.
